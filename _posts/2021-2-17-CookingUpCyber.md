...
Add two parts cyber and one part input to produce a delicious recipe. All joking aside, [CyberChef](https://gchq.github.io/CyberChef/) is a pretty sweet tool that anyone in the cybersecurity community would likely find useful. It really is the entire kitchen sink with over 300 unique operations which can be combined in different ways to help analyze input data. The input could be a file or just a chunk of data you want to copy/paste into the tool. CyberChef can be downloaded and ran locally in a web browser, or ran online in the github-io hosted version. I've [referenced](#references) several good collections of recipes below to help with understand how CyberChef can be used. One thing I sometimes want to do with CyberChef that I havent seen blogged about, is look at Shellcode. In this blog I'll walk through a simple example of looking at some Shellcode and determining what is pushed onto the stack.  
...
![disassembly](/images/shellcodedisassembly.PNG)
